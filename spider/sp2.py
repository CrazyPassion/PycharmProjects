...
class spider(object):
    ...
    def downloadpic(self,source,num):
        # print source
        picsource = re.findall('<div class="content-pic">(.*?)/></a></div>',source,re.S)
        # realsource = re.findall('href=(.*)"',picsource[0], re.S)
        print 'picsource:'+picsource[0].decode('gbk')
        # print 'picsource:'+realsource[0].decode('gbk')
...
if __name__ == '__main__':
    ...
    try:
        ...
        if e.errno != 17:
            raise
    # ssspider.saveonelink('http://www.mm131.com/xinggan/2266.html')
